...
function Footer() {
  return (
    <footer>
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 bg-green-600/10 md:pl-16 px-4 py-6 gap-x-4">
        <div>
        ...
        <div>
          <h4 className="text-2xl font-medium mb-4 mt-8 sm:mt-0">
            Darul Hikmah Islamic Center
          </h4>
          <ul>
      ...
      <div className="md:pl-16 px-4 bg-green-600/40 py-4 text-center font-medium ">
